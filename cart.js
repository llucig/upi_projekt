  ...
  function updateCart() {
    ...
    cartItems.forEach((item, index) => {
      ...
      document.addEventListener("DOMContentLoaded", function () {
        const cartItemsContainer = document.getElementById("cartItems");
        const totalPriceElement = document.getElementById("totalPrice");
        const totalWithDeliveryElement =
          document.getElementById("totalWithDelivery");
        const deliveryAddressInput = document.getElementById("deliveryAddress");
        const deliveryPhoneNumberInput = document.getElementById(
          "deliveryPhoneNumber"
        );
        ...
        const storedDeliveryPhoneNumber = localStorage.getItem(
          "deliveryPhoneNumber"
        );
        ...
        if (saveDeliveryDetailsButton) {
          saveDeliveryDetailsButton.addEventListener(
            "click",
